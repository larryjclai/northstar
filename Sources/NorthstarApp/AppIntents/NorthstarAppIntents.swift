...
enum NorthstarTabIntentOption: String, AppEnum {
    ...
    static var typeDisplayRepresentation: TypeDisplayRepresentation = "頁面"
...
struct OpenNorthstarTabIntent: AppIntent {
    ...
    static var description = IntentDescription("開啟指定頁面到 northstar。")
...
struct AddInvestmentRecordIntent: AppIntent {
    ...
    static var description = IntentDescription("開啟 app 並進入新增交易。")
    static var openAppWhenRun = true
