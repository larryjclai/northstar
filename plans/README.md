...
- **115 Phase 2**: per-file inline-style cleanup, one file per dispatch. Ongoing.
  ...
  - **Next targets** (by inline count): DashboardRoute (~160) → AccountsRoute (~115) → settings/ConnectSection (~101) → FIRECalculatorRoute (~101) → rest >40. Repo-wide inline now **1994** (was 2157 at Phase 2 start).
