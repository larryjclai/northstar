...
- **115 Phase 2**: per-file inline-style cleanup, one file per dispatch. Ongoing.
  ...
  - **Next targets** (by inline count): AccountsRoute (~115) → settings/ConnectSection (~101) → FIRECalculatorRoute (~101) → HoldingDetailRoute (~78) → InvestmentImportWizard (~77) → rest >40. Repo-wide inline now **1933** (was 2157 at Phase 2 start).
