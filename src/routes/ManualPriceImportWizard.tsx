...
import {
  DATE_FORMAT_LABELS,
  MANUAL_PRICE_FIELDS,
  MANUAL_PRICE_FIELD_LABELS,
  MANUAL_PRICE_REQUIRED_FIELDS,
...
export function ManualPriceImportWizard({
  open,
  onClose,
  assetId,
  assetLabel,
  ...
  useEffect(() => {
    ...
    setHeaders([]);
    setRows([]);
    setMapping(emptyManualPriceMapping());
    setImportError("");
  }, [open]);
    ...
    >
      {(dismiss) => (
        <>
          ...
          <div
            className="flex"
            style={{ gap: 8, padding: "14px 22px", borderBottom: "1px solid var(--ns-border)" }}
          >
            {steps.map((s, i) => {
              ...
              return (
                <div
                  ...
                  style={{ gap: 8, opacity: active || done ? 1 : 0.5 }}
                >
                  <div
                    ...
                    {MANUAL_PRICE_FIELDS.map((field) => {
                      ...
                      return (
                        <div key={field}>
                          ...
                          >
                            {MANUAL_PRICE_FIELD_LABELS[field]}
                            {required && <span className="neg"> *</span>}
                          </label>
                          <AppSelect
...
function StatPill({
  ...
  return (
    ...
    >
      <div className="text-xs muted font-medium" style={{ marginBottom: 2 }}>
        {label}
      </div>
